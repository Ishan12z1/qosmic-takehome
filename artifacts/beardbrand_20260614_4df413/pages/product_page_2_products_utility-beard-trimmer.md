The Beardbrand Utility Beard Trimmer
...
"price": 124.95,
"priceCurrency": "USD",
"priceValidUntil": "2026-06-24","sku": "8882820","url": "https://www.beardbrand.com/products/utility-beard-trimmer?variant=42135547969619",
"eligibleRegion": {
"@type": "Country",
"name": "US"
},
...
"productId": "850045850241","brand": {
"name": "Beardbrand"
},
"name": "Utility Beard Trimmer",
"description": "Made with our friends at Brio, this custom special-edition Beardbrand Utility Beard Trimmer features an iced-out colorway, a full set of matching guards, an incredibly smooth ceramic blade, and 240 minutes of runtime between charges. The Utility Trimmer is designed for beard, hair, and body use. Limited quantity available.",
"category": "Tools",
"url": "https://www.beardbrand.com/products/utility-beard-trimmer",
"sku": "8882820",
"image": {
"@type": "ImageObject",
"url": "https://www.beardbrand.com/cdn/shop/files/ut\_d4738bfb-0410-40d3-9bf1-6775c2c303ee\_1024x.jpg?v=1762459278",
"image": "https://www.beardbrand.com/cdn/shop/files/ut\_d4738bfb-0410-40d3-9bf1-6775c2c303ee\_1024x.jpg?v=1762459278",
"name": "The Beardbrand Utility Trimmer with a sleek design. It features a metal trimming head, a power button, and a small digital display on its body.",
"width": "1024",
"height": "1024"
}
}
...
"position": 2,
"name": "Utility Beard Trimmer",
"item": "https://www.beardbrand.com/products/utility-beard-trimmer"
}]
}
{
"@context": "https://schema.org",
...
var \_\_st={"a":2090478,"offset":-18000,"reqid":"b8f8497b-c76f-4f43-aa78-92ac35fbda13-1781460380","pageurl":"www.beardbrand.com\/products\/utility-beard-trimmer","u":"e7cf734271eb","p":"product","rtyp":"product","rid":7432276279379};
...
MetafieldReviews = {"rating":{"scale\_min":"1.0","scale\_max":"5.0","value":"4.74"},"rating\_count":35};
...
Categories: ["All Products","Beard","Body","Close Cut Styles","Combs, Brushes \u0026 Tools","Every Product","Hair","Hybrid Styles","Mustache Centric Styles","Style","Tools","Tools + Gear","Versatile Styles"],
ImageURL: "https://www.beardbrand.com/cdn/shop/files/ut\_d4738bfb-0410-40d3-9bf1-6775c2c303ee\_grande.jpg?v=1762459278",
URL: "https://www.beardbrand.com/products/utility-beard-trimmer",
Brand: "Beardbrand",
Price: "$124.95",
Value: "124.95",
...
{
const getPage = () => "product.utility-trimmer";
...
currency: "USD",
collections: ["All Products","Beard","Body","Close Cut Styles","Combs, Brushes \u0026 Tools","Every Product","Hair","Hybrid Styles","Mustache Centric Styles","Style","Tools","Tools + Gear","Versatile Styles"],
tags: ["auto\_bundle","bundle-able","close\_cut\_styles","hybrid\_styles","limited badge","mustache\_centric\_styles","versatile\_styles"]
});
const getProducts = () => {
};
...
window.ShopifyAnalytics.lib.page(null,{"pageType":"product","resourceType":"product","resourceId":7432276279379,"requestId":"b8f8497b-c76f-4f43-aa78-92ac35fbda13-1781460380","shopifyEmitted":true});
var match = window.location.pathname.match(/checkouts\/(.+)\/(thank\_you|post\_purchase)/)
var token = match? match[1]: undefined;
if (!hasLoggedConversion(token)) {
setCookieIfConversion(token);
window.ShopifyAnalytics.lib.track("Viewed Product",{"currency":"USD","variantId":42135547969619,"productId":7432276279379,"productGid":"gid:\/\/shopify\/Product\/7432276279379","name":"Utility Beard Trimmer","price":"124.95","sku":"8882820","brand":"Beardbrand","variant":null,"category":"Tools","nonInteraction":true,"remote":false},undefined,undefined,{"shopifyEmitted":true});
window.ShopifyAnalytics.lib.track("monorail:\/\/trekkie\_storefront\_viewed\_product\/1.1",{"currency":"USD","variantId":42135547969619,"productId":7432276279379,"productGid":"gid:\/\/shopify\/Product\/7432276279379","name":"Utility Beard Trimmer","price":"124.95","sku":"8882820","brand":"Beardbrand","variant":null,"category":"Tools","nonInteraction":true,"remote":false,"referer":"https:\/\/www.beardbrand.com\/products\/utility-beard-trimmer"});
}
});
...
function ProductHeaderHelper(selector) {
console.log('ProductHeaderHelper function called for', selector);
}


@media screen and (max-width: 768px), screen and (max-width: 1024px) and (orientation: portrait) {
#css-slider-template--27795705889138\_\_main:not(.enabled):not([data-size="1"]) {
overflow: hidden;
padding-bottom: 60px;
}
#css-slider-template--27795705889138\_\_main:not(.enabled):not([data-size="1"]) .product-gallery-item:not(:first-of-type) {
display: none;
}
}

![The Beardbrand Utility Trimmer with a sleek design. It features a metal trimming head, a power button, and a small digital display on its body.](//www.beardbrand.com/cdn/shop/files/ut_d4738bfb-0410-40d3-9bf1-6775c2c303ee.jpg?v=1762459278&width=640)

![A product layout of the Beardbrand Utility Trimmer set. The image shows the main trimmer unit, five different sized attachment guards, a charging base, and a power adapter. All items are matching the minimalist aesthetic of the trimmer.](//www.beardbrand.com/cdn/shop/files/UT_all-parts.jpg?v=1724863344&width=640)

![The Beardbrand Utility Trimmer with a sleek design. It features a metal trimming head, a power button, and a small digital display on its body.](//www.beardbrand.com/cdn/shop/files/ut_d4738bfb-0410-40d3-9bf1-6775c2c303ee_64x64_crop_center.jpg?v=1762459278)
![A product layout of the Beardbrand Utility Trimmer set. The image shows the main trimmer unit, five different sized attachment guards, a charging base, and a power adapter. All items are matching the minimalist aesthetic of the trimmer.](//www.beardbrand.com/cdn/shop/files/UT_all-parts_64x64_crop_center.jpg?v=1724863344)

Preorder section for the Beardbrand Utility Trimmer
...
ProductHeaderHelper('#product-template--27795705889138\_\_main');

Made with our friends at Brio, this custom special-edition Beardbrand Utility Beard Trimmer features an iced-out colorway, a full set of matching guards, an incredibly smooth ceramic blade, and 240 minutes of runtime between charges. The Utility Trimmer is designed for beard, hair, and body use. Limited quantity available.

[{"id":42135547969619,"title":"Default Title","option1":"Default Title","option2":null,"option3":null,"sku":"8882820","requires\_shipping":true,"taxable":true,"featured\_image":null,"available":true,"name":"Utility Beard Trimmer","public\_title":null,"options":["Default Title"],"price":12495,"weight":907,"compare\_at\_price":null,"inventory\_quantity":60,"inventory\_management":"shopify","inventory\_policy":"deny","barcode":"850045850241","requires\_selling\_plan":false,"selling\_plan\_allocations":[],"quantity\_rule":{"min":1,"max":null,"increment":1}}]
...
document.getElementById('add-to-cart-template--27795705889138\_\_main').querySelector('form').append(document.getElementById('add-to-cart-template--27795705889138\_\_main').querySelector('template').content.cloneNode(true));
...
UTILITY BEARD TRIMMER FEATURES

* Premium materials and finishing
* Cutting Range 1mm - 20mm
* A runtime of 240 minutes that lets you go months between charges
* Travel Lock (so it won’t turn on by accident while traveling)
* Adjustable blade
* Includes full set of matching guards
* Compatible with the Brio zero guard (not included)
* Utility Trimmer is designed for use on all body parts

UTILITY BEARD TRIMMER FAQs

Is the Beardbrand Utility Beard Trimmer Compatible with the Brio Zero Guard?
----------------------------------------------------------------------------

Yes. You can use a Brio Zero Guard with the Beardbrand Utility Trimmer. A Brio Zero Guard is not included with the Beardbrand Utility Trimmer.

What Is the Cutting Range on the Beardbrand Utility Beard Trimmer?
------------------------------------------------------------------

The Beardbrand Utility Beard Trimmer features a cutting range of 1mm – 20mm.
...
/\* Default styling for screens smaller than 1224px \*/
.product--add-to-cart-form {
margin-bottom: 0.5em !important;
}
div.site-box-content.reduce-top-margin {
display: flex;
flex-direction: column;
...
/\* Media query for screens 1224px and larger \*/
...
{
"42135547969619": {
"shipping\_alert": null,
"cost\_per\_day\_display": null,
"cost\_per\_day\_display\_info\_copy": null,
"badge\_html": null,
"components\_available": true
}
}

{"id":7432276279379,"title":"Utility Beard Trimmer","handle":"utility-beard-trimmer","description":"\u003cp\u003eMade with our friends at Brio, this custom special-edition Beardbrand Utility Beard Trimmer features an iced-out colorway, a full set of matching guards, an incredibly smooth ceramic blade, and 240 minutes of runtime between charges. The Utility Trimmer is designed for beard, hair, and body use. Limited quantity available.\u003c\/p\u003e","published\_at":"2024-08-29T11:17:41-05:00","created\_at":"2024-08-28T11:00:43-05:00","vendor":"Beardbrand","type":"Tools","tags":["auto\_bundle","bundle-able","close\_cut\_styles","hybrid\_styles","limited badge","mustache\_centric\_styles","versatile\_styles"],"price":12495,"price\_min":12495,"price\_max":12495,"available":true,"price\_varies":false,"compare\_at\_price":null,"compare\_at\_price\_min":0,"compare\_at\_price\_max":0,"compare\_at\_price\_varies":false,"variants":[{"id":42135547969619,"title":"Default Title","option1":"Default Title","option2":null,"option3":null,"sku":"8882820","requires\_shipping":true,"taxable":true,"featured\_image":null,"available":true,"name":"Utility Beard Trimmer","public\_title":null,"options":["Default Title"],"price":12495,"weight":907,"compare\_at\_price":null,"inventory\_quantity":60,"inventory\_management":"shopify","inventory\_policy":"deny","barcode":"850045850241","requires\_selling\_plan":false,"selling\_plan\_allocations":[],"quantity\_rule":{"min":1,"max":null,"increment":1}}],"images":["\/\/www.beardbrand.com\/cdn\/shop\/files\/ut\_d4738bfb-0410-40d3-9bf1-6775c2c303ee.jpg?v=1762459278","\/\/www.beardbrand.com\/cdn\/shop\/files\/UT\_all-parts.jpg?v=1724863344"],"featured\_image":"\/\/www.beardbrand.com\/cdn\/shop\/files\/ut\_d4738bfb-0410-40d3-9bf1-6775c2c303ee.jpg?v=1762459278","options":["Title"],"media":[{"alt":"The Beardbrand Utility Trimmer with a sleek design. It features a metal trimming head, a power button, and a small digital display on its body.","id":28273928110163,"position":1,"preview\_image":{"aspect\_ratio":1.0,"height":1500,"width":1500,"src":"\/\/www.beardbrand.com\/cdn\/shop\/files\/ut\_d4738bfb-0410-40d3-9bf1-6775c2c303ee.jpg?v=1762459278"},"aspect\_ratio":1.0,"height":1500,"media\_type":"image","src":"\/\/www.beardbrand.com\/cdn\/shop\/files\/ut\_d4738bfb-0410-40d3-9bf1-6775c2c303ee.jpg?v=1762459278","width":1500},{"alt":"A product layout of the Beardbrand Utility Trimmer set. The image shows the main trimmer unit, five different sized attachment guards, a charging base, and a power adapter. All items are matching the minimalist aesthetic of the trimmer.","id":28049580359763,"position":2,"preview\_image":{"aspect\_ratio":1.0,"height":1200,"width":1200,"src":"\/\/www.beardbrand.com\/cdn\/shop\/files\/UT\_all-parts.jpg?v=1724863344"},"aspect\_ratio":1.0,"height":1200,"media\_type":"image","src":"\/\/www.beardbrand.com\/cdn\/shop\/files\/UT\_all-parts.jpg?v=1724863344","width":1200}],"requires\_selling\_plan":false,"selling\_plan\_groups":[],"content":"\u003cp\u003eMade with our friends at Brio, this custom special-edition Beardbrand Utility Beard Trimmer features an iced-out colorway, a full set of matching guards, an incredibly smooth ceramic blade, and 240 minutes of runtime between charges. The Utility Trimmer is designed for beard, hair, and body use. Limited quantity available.\u003c\/p\u003e"}

div.rc-template\_\_radio-group > div.rc-radio-group\_\_options {
border-radius: 0px!important;
}
.rc-template\_\_radio-group .rc-radio-group\_\_options {
...
.product-page-quantity .qty-button,
...
.button-scroll-in.add-to-cart\_\_text {
font-size: 80%;
}
}
@media screen and (max-width: 1223px) and (min-width: 360px) {
.plus-flex-container {
flex-direction: row;
}
.buttons-holder-fix {
...
padding: 0 5px;
 ...
 #shopify-section-template--27795705889138\_\_main h1.product-title {margin-bottom: 0.3em !important;} #shopify-section-template--27795705889138\_\_main div.product-variant {margin-bottom: 0.65em !important;} #shopify-section-template--27795705889138\_\_main div.product-variants.product-variants--radio {margin-bottom: 0.5em !important;} #shopify-section-template--27795705889138\_\_main div.rte {margin-bottom: 1em;} #shopify-section-template--27795705889138\_\_main div.product-header-element {margin-bottom: 0.5em !important;} #shopify-section-template--27795705889138\_\_main .quantity-selector-holder {margin-bottom: 0em !important;}
...
.secondary-atc-section product-quantity {
width: 40%;
margin-bottom: 15px;
}
.secondary-atc-section .product\_\_add-to-cart {
margin-bottom: 15px;
}
...
.secondary-atc.fixed.fixed--is-closed {
bottom: -75px;
}
.secondary-atc.fixed.fixed--is-open {
bottom: 0;
}
.secondary-atc {
background: #f9f8f6;
...
.kog-text-color {
color: #101010; /\* Corrected color code formatting \*/
}
.kog-highlight {
text-align: center;
padding: 40px 40px 30px; /\* top, right/left, bottom \*/
...
#kog-heading {
font-size: calc(24px / 60 \* var(--base-headings-size) + 0px); /\* Smaller font size \*/
}
.kog-highlight {
...
![Eric Bandholz, Founder of Beardbrand, holding up the new Utility Trimmer close to the camera. The trimmer's display shows the current speed setting and battery level, with Eric's face slightly blurred in the background.](//www.beardbrand.com/cdn/shop/files/Screenshot_2024-09-03_at_12.07.07_PM.jpg?v=1725380308&width=2400)

{
"@context": "https://schema.org",
"@type": "VideoObject",
"name": "How to Trim Beard When Growing It Out - Eric Bandholz",
"description": "Eric Bandholz talks about how to trim your beard while it's growing out and using the new Beardbrand Utility Trimmer along with highlighting all the trimmer's features.",
"thumbnailUrl": [
"https:\/\/www.beardbrand.com\/cdn\/shop\/files\/Screenshot\_2024-09-03\_at\_12.07.07\_PM.jpg?v=1725380308\u0026width=1200"
],
"uploadDate": "2024-09-02T00:00:00-05:00"
,
"duration": "PT13M013S"
,
"embedUrl": "https:\/\/www.youtube-nocookie.com\/embed\/MTs2g-qs7ck?autoplay=1\u0026playsinline=1\u0026rel=0\u0026modestbranding=1"
}

#custom-pdp-video-template--27795705889138\_\_custom\_pdp\_video\_TnXt8C {
width: 100%;
}
#custom-pdp-video-template--27795705889138\_\_custom\_pdp\_video\_TnXt8C .custom-pdp-video\_\_wrapper {
position: relative;
width: 100%;
aspect-ratio: 16 / 9;
overflow: hidden;
...
#custom-pdp-video-template--27795705889138\_\_custom\_pdp\_video\_TnXt8C .custom-pdp-video\_\_button,
#custom-pdp-video-template--27795705889138\_\_custom\_pdp\_video\_TnXt8C .custom-pdp-video\_\_embed,
#custom-pdp-video-template--27795705889138\_\_custom\_pdp\_video\_TnXt8C iframe,
#custom-pdp-video-template--27795705889138\_\_custom\_pdp\_video\_TnXt8C video {
position: absolute;
inset: 0;
width: 100%;
height: 100%;
...
#custom-pdp-video-template--27795705889138\_\_custom\_pdp\_video\_TnXt8C .custom-pdp-video\_\_button:focus-visible {
outline: 3px solid currentColor;
outline-offset: -6px;
}
#custom-pdp-video-template--27795705889138\_\_custom\_pdp\_video\_TnXt8C .custom-pdp-video\_\_thumbnail {
display: block;
width: 100%;
height: 100%;
object-fit: cover;
}
#custom-pdp-video-template--27795705889138\_\_custom\_pdp\_video\_TnXt8C .custom-pdp-video\_\_play-icon {
position: absolute;
top: 50%;
left: 50%;
width: 60px;
...
#custom-pdp-video-template--27795705889138\_\_custom\_pdp\_video\_TnXt8C .custom-pdp-video\_\_play-icon svg {
display: block;
width: 100%;
height: 100%;
}
#custom-pdp-video-template--27795705889138\_\_custom\_pdp\_video\_TnXt8C .custom-pdp-video\_\_button:hover .custom-pdp-video\_\_play-icon,
#custom-pdp-video-template--27795705889138\_\_custom\_pdp\_video\_TnXt8C .custom-pdp-video\_\_button:focus-visible .custom-pdp-video\_\_play-icon {
transform: translate(-50%, -50%) scale(1.05);
}
#custom-pdp-video-template--27795705889138\_\_custom\_pdp\_video\_TnXt8C .custom-pdp-video\_\_embed[hidden],
#custom-pdp-video-template--27795705889138\_\_custom\_pdp\_video\_TnXt8C .custom-pdp-video\_\_button[hidden] {
display: none;
}
#custom-pdp-video-template--27795705889138\_\_custom\_pdp\_video\_TnXt8C iframe {
border: 0;
...
(() => {
const section = document.getElementById("custom-pdp-video-template--27795705889138\_\_custom\_pdp\_video\_TnXt8C");
if (!section || section.dataset.customPdpVideoInitialized === 'true') return;
section.dataset.customPdpVideoInitialized = 'true';
const button = section.querySelector('[data-custom-pdp-video-button]');
const embedContainer = section.querySelector('[data-custom-pdp-video-embed]');
if (!button || !embedContainer) return;
button.addEventListener('click', () => {
const videoSource = button.dataset.videoSource;
const videoTitle = button.dataset.videoTitle || 'Product video';
embedContainer.innerHTML = '';
if (videoSource === 'mp4') {
const video = document.createElement('video');
video.src = button.dataset.videoFileUrl;
video.setAttribute('playsinline', '');
video.setAttribute('aria-label', videoTitle);
video.setAttribute('tabindex', '-1');
video.preload = 'metadata';
if (button.dataset.mp4Controls === 'true') {
video.controls = true;
}
if (button.dataset.videoLoop === 'true') {
video.loop = true;
}
...
button.hidden = true;
video.focus();
if (button.dataset.mp4PlayAfterClick === 'true') {
video.play().catch(() => {
video.controls = true;
});
}
...
iframe.src = button.dataset.videoEmbedUrl;
...
#section-template--27795705889138\_\_jdgm\_testimonials\_v2\_fbfnFU {
...
Utility Beard Trimmer Reviews
-----------------------------

[4.74 out of 5](https://app.judge.me/reviews/stores/beardbrand.com)
...
I’m very happy with this trimmer, I wasn’t sure I wanted to pay this much for a trimmer, but I’m very happy that I did. Very high quality, just like the rest of Beardbrand products.
...
Feels like quality, works great, and has built-in reminders for when to oil the blades and charge the battery (neither of which need to happen often.) I’m very pleased with this trimmer and I expect to use it for years.
...
Jimmy ![Verified by Shop]()

100% the best trimmer Ive owned. Great clean cuts and holds one of the longest charges ive seen
...
**Awesome for design or upkeep!**

I found this trimmer great for trimming, shaping, and edging.
...
I've been using the Brio beardscape for 7 years and wanted to upgrade to the Beardbrand's Utility Beard Trimmer. The trimmer is nice and cuts efficiently. Love the color and the screen, and the lock feature. Good blade. The back of the trimmer arrived with a small crack, but I don't blame Beardbrand for that. Really love Beardbrand's mission statement, and the incredible work they do for men. Thanks guys.
...
.marquee-template--27795705889138\_\_marquee\_banner\_LwK9ED {
display: flex;
overflow: hidden;
height: 10vh;
user-select: none;
...
.marquee-template--27795705889138\_\_marquee\_banner\_LwK9ED .marquee\_\_group {
flex-shrink: 0;
display: flex;
align-items: center;
justify-content: space-between;
gap: 2rem;
min-width: 100%;
animation: scroll-template--27795705889138\_\_marquee\_banner\_LwK9ED 60s linear infinite;
}
.marquee-template--27795705889138\_\_marquee\_banner\_LwK9ED .marquee\_\_group .marquee-text {
color: #101010;
font-family: var(--font-stack-headings);
font-weight: var(--font-weight-headings);
font-style: var(--font-style-headings);
...
.marquee-template--27795705889138\_\_marquee\_banner\_LwK9ED .marquee\_\_group .marquee-text a {
color: inherit;
text-decoration: none;
}
.marquee-template--27795705889138\_\_marquee\_banner\_LwK9ED .marquee\_\_group .marquee-text a:hover {
opacity: 0.8;
}
.marquee-template--27795705889138\_\_marquee\_banner\_LwK9ED .marquee\_\_group .separator {
color: #101010;
font-family: var(--font-stack-headings);
font-weight: var(--font-weight-headings);
font-style: var(--font-style-headings);
...
/\* Scrolling animation \*/
@keyframes scroll-template--27795705889138\_\_marquee\_banner\_LwK9ED {
from {
...
.marquee-template--27795705889138\_\_marquee\_banner\_LwK9ED:hover .marquee\_\_group {
...
/\* Apply 8vh height for screens 770px and smaller \*/
...
Our Core Values: Freedom, Hunger & Trust
...
#section-template--27795705889138\_\_1651776352d4a0ff45 {
--main-background: #f9f8f6;
}
#section-template--27795705889138\_\_1651776352d4a0ff45 {
--main-text: #101010;
...
[![Norse Winter Men's Cologne](//www.beardbrand.com/cdn/shop/files/EDP_NW.jpg?v=1771173573&width=640)

![Norse Winter Men's Cologne](//www.beardbrand.com/cdn/shop/files/edp_nw_pinesprig.jpg?v=1774983031&width=640)

Norse Winter Men's Cologne

$50

Rating: 4.59 out of 5.0

4.6

Sold out](/products/norse-winter-mens-cologne)

[![Bold Fortune Men's Cologne](//www.beardbrand.com/cdn/shop/files/EDP_BF_KO.jpg?v=1771173573&width=640)

![Bold Fortune Men's Cologne](//www.beardbrand.com/cdn/shop/files/edp_bf_saffron.jpg?v=1774986532&width=640)

Bold Fortune Men's Cologne

$50

Rating: 4.27 out of 5.0

4.3

Sold out](/products/bold-fortune-mens-cologne)


[Add to cart](/products/bold-fortune-mens-cologne)

[![Old Money Men's Cologne](//www.beardbrand.com/cdn/shop/files/EDP_OM_KO.jpg?v=1771173573&width=640)

![Old Money Men's Cologne](//www.beardbrand.com/cdn/shop/files/edp_om_coins.jpg?v=1774986373&width=640)

Old Money Men's Cologne
...
Sold out](/products/old-money-mens-cologne)


[Add to cart](/products/old-money-mens-cologne)

[![Temple Smoke Men's Cologne](//www.beardbrand.com/cdn/shop/files/EDP_TS_KO.jpg?v=1766430411&width=640)

![Temple Smoke Men's Cologne](//www.beardbrand.com/cdn/shop/files/edp_ts_palosanto.jpg?v=1774988112&width=640)

Temple Smoke Men's Cologne

$45

Rating: 4.11 out of 5.0

4.1

Sold out](/products/temple-smoke-mens-cologne)


[Add to cart](/products/temple-smoke-mens-cologne)
...
[![Alliance Membership](//www.beardbrand.com/cdn/shop/files/am_bafc0ce7-8731-4ed2-8154-867c1c43d2c5.jpg?v=1762457249&width=640)

![Alliance Membership](//www.beardbrand.com/cdn/shop/products/Carlos_Eric_Greg__37_of_80.jpg?v=1706297622&width=640)
...
Sold out](/products/alliance-membership)



Add to cart

[![Book of Reminders](//www.beardbrand.com/cdn/shop/files/bor_72d99eff-d498-4347-9d04-939869b83997.jpg?v=1762457617&width=640)

Book of Reminders

$10

Rating: 4.95 out of 5.0

5

Sold out](/products/book-of-reminders)
...
[Explore all](/collections/all-products-collection)

 #shopify-section-template--27795705889138\_\_1651776352d4a0ff45 .site-box-container {border-top: 1px solid var(--main-borders);}
...
[Account Login](https://account.beardbrand.com/orders?locale=en&region_country=US&buyer_flags=eyJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJiZWFyZGJyYW5kLm15c2hvcGlmeS5jb20iLCJmbGFncyI6W10sImV4cCI6MTc4MjA2NTE4MCwibmJmIjoxNzgxNDYwMzgwfQ.-HlYBLLmIVioFcBno-iHq8QgBMzjzx_xhkcWxcUHghk)
...
[Judge.me](#)![](https://aa.trkn.us/1/e/c.gif?cid=c013&evid=4d746137-8d1d-465b-981b-f81f6382dec0&r=1781460427742&dmn=www.beardbrand.com&pn=/products/utility-beard-trimmer&qs=&suu=1&v1=&v2=SkE8m&v3=64X3AR0vG5jZhN3H_mqe3j8kn&v4=C7xwofhAv5eFetRb_mqe3j8kn&v5=2674)
