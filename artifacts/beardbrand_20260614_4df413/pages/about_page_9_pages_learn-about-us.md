...
"@type": "ListItem",
"position": 2,
"name": "Learn About Beardbrand",
"item": "https://www.beardbrand.com/pages/learn-about-us"
}]
}
{
"@context": "https://schema.org",
...
var \_\_st={"a":2090478,"offset":-18000,"reqid":"a27c47cb-aeeb-4229-b915-19891ddcaafd-1781460402","pageurl":"www.beardbrand.com\/pages\/learn-about-us","s":"pages-84152385619","u":"ef45d0c67060","p":"page","rtyp":"page","rid":84152385619};
...
{
const getPage = () => "page.learn-aboutus";
...
window.ShopifyAnalytics.lib.page(null,{"pageType":"page","resourceType":"page","resourceId":84152385619,"requestId":"a27c47cb-aeeb-4229-b915-19891ddcaafd-1781460402","shopifyEmitted":true});
...
Learn About Beardbrand - Keep on Growing
========================================

![Beardbrand Grooming Stories from Eric Bandholz, video thumbnail](//cdn.shopify.com/s/files/1/0209/0478/files/Screen_Shot_2022-09-22_at_4.41.57_PM.jpg?v=1713388188)

Play video
Click to load the video about Beardbrand Grooming Stories from Eric Bandholz.

.videoWrapper-with-facade {
position: relative;
padding-bottom: 56.25%; /\* 16:9 Aspect Ratio \*/
height: 0;
cursor: pointer; /\* Ensure it's clear that the wrapper is clickable \*/
}
.videoWrapper-with-facade iframe, .videoWrapper-with-facade img, .videoWrapper-with-facade svg {
position: absolute;
top: 0;
left: 0;
width: 100%;
...
function loadVimeoVideoWithFacade(event) {
// Prevent any default click behavior, if necessary
event.preventDefault();
var facade = document.getElementById('videoFacade-with-facade');
var container = document.getElementById('videoContainer-with-facade');
// Attempt to display the video container
try {
facade.style.display = 'none'; // Hide the facade
container.style.display = 'block'; // Show the video iframe
} catch (error) {
console.error("Failed to load video: ", error);
// Optionally, handle the error by showing an error message to the user
alert("There was a problem loading the video. Please try again later.");
}
}
...
"@context": "https://schema.org",
"@type": "VideoObject",
"name": "Beardbrand Grooming Stories - Eric Bandholz",
"description": "Eric Bandholz talks about where he was 10 years ago and how he's evolved into the man he is today. The main catalyst was grooming.",
"thumbnailUrl": [
"https://cdn.shopify.com/s/files/1/0209/0478/files/Screen\_Shot\_2022-09-22\_at\_4.41.57\_PM.jpg?v=1713388188"
],
"uploadDate": "2019-11-14T12:01:00-05:00",
"contentUrl": "https://www.youtube.com/watch?v=kKLe60GM8NQ",
"embedUrl": "https://www.youtube.com/embed/kKLe60GM8NQ"
}

#section-template--27795704676722\_\_e3c1eefe-e834-4826-9bc2-6453985e305d {
--main-background: #f9f8f6;
}
#section-template--27795704676722\_\_e3c1eefe-e834-4826-9bc2-6453985e305d {
--main-text: #101010;
...
Beardbrand was founded to help *yo*u be the person that *you* want to be—beard or no beard.  
...
#section-template--27795704676722\_\_bcefd39f-ab04-46d6-908d-912e3bb27d02 {
--main-background: #f9f8f6;
}
#section-template--27795704676722\_\_bcefd39f-ab04-46d6-908d-912e3bb27d02 {
--main-text: #101010;
...
#section-template--27795704676722\_\_8df7f88d-bee9-4e75-8576-52fc980a53ba {
--main-background: #f9f8f6;
}
#section-template--27795704676722\_\_8df7f88d-bee9-4e75-8576-52fc980a53ba {
--main-text: #101010;
...
![](//www.beardbrand.com/cdn/shop/files/Short-Rounded-Beard_5e20fa52-c770-49a9-a46d-3710ea9e29e4.jpg?v=1692473241&width=640)

### What Type of Beardsman are You?

All beardsmen are awesome, but some are less common than others. Take this quick quiz to find out what type you are.

[Take Quiz](/pages/beardsman-quiz "Take Quiz")
...
#section-template--27795704676722\_\_c352c37e-3348-4c92-83cc-b9e83f18380b {
--main-background: #f9f8f6;
}
#section-template--27795704676722\_\_c352c37e-3348-4c92-83cc-b9e83f18380b {
--main-text: #101010;
...
![](//www.beardbrand.com/cdn/shop/files/P1010071_1920x1080_c802c07d-8b61-4c79-b539-3ff3e2aceb76.jpg?v=1669061062&width=640)

### What's the Best Beard Style for You?

Take this 10 question quiz to find out what which beard styles we recommend for you!

[Take Quiz](/pages/beard-style-quiz "Take Quiz")
...
3. We believe product versatility simplifies routines and creates better grooming habits.
 ...
 @media screen .and (min-width: 1367px) {#shopify-section-template--27795704676722\_\_9b264fa2-67fb-4696-95b4-583c7c2e9bf2 h2 {font-size: calc(60px / 60 \* var(--base-headings-size) + 0px); }} @media screen and (min-width: 1024px) and (max-width: 1367px) {#shopify-section-template--27795704676722\_\_9b264fa2-67fb-4696-95b4-583c7c2e9bf2 h2 {font-size: calc(48px / 60 \* var(--base-headings-size) + 0px); }} @media screen and (min-width: 768px) and (max-width: 1024px) {#shopify-section-template--27795704676722\_\_9b264fa2-67fb-4696-95b4-583c7c2e9bf2 h2 {font-size: calc(42px / 60 \* var(--base-headings-size) + 0px); }} @media screen and (max-width: 768px) {#shopify-section-template--27795704676722\_\_9b264fa2-67fb-4696-95b4-583c7c2e9bf2 h2 {font-size: calc(32px / 60 \* var(--base-headings-size) + 0px); }}

#section-template--27795704676722\_\_88099721-4d0f-43aa-bc7e-46769c8a8253 {
--main-background: #f9f8f6;
}
#section-template--27795704676722\_\_88099721-4d0f-43aa-bc7e-46769c8a8253 {
--main-text: #101010;
...
![](//www.beardbrand.com/cdn/shop/files/mw_sliders_web_8a31a049-c91d-4e73-9acd-f9fc57009044.jpg?v=1668548519&width=640)
...
[Read the Post](/blogs/urbanbeardsman/materials-matter "Read the Post")
...
margin-bottom: 125px; /\* Spacing below the heading \*/
 ...
 @media screen and (max-width: 768px) {#shopify-section-template--27795704676722\_\_88099721-4d0f-43aa-bc7e-46769c8a8253 h2 {font-size: calc(32px / 60 \* var(--base-headings-size)); }} @media screen and (min-width: 768px) and (max-width: 1024px) {#shopify-section-template--27795704676722\_\_88099721-4d0f-43aa-bc7e-46769c8a8253 h2 {font-size: calc(42px / 60 \* var(--base-headings-size)); }} @media screen and (min-width: 1024px) and (max-width: 1367px) {#shopify-section-template--27795704676722\_\_88099721-4d0f-43aa-bc7e-46769c8a8253 h2 {font-size: calc(48px / 60 \* var(--base-headings-size)); }} @media screen and (min-width: 1367px) {#shopify-section-template--27795704676722\_\_88099721-4d0f-43aa-bc7e-46769c8a8253 h2 {font-size: calc(60px / 60 \* var(--base-headings-size)); }} #shopify-section-template--27795704676722\_\_88099721-4d0f-43aa-bc7e-46769c8a8253 h4 {font-size: calc(16px / 16 \* var(--base-body-size)); font-family: var(--font-stack-body);}

#section-template--27795704676722\_\_7428741c-ac2a-45f5-91c5-6abe345d3f9b {
--main-background: #f9f8f6;
}
#section-template--27795704676722\_\_7428741c-ac2a-45f5-91c5-6abe345d3f9b {
--main-text: #101010;
...
![](//www.beardbrand.com/cdn/shop/files/UO_3_CONCRETE-NEON.jpg?v=1676409913&width=640)

Battle scars proudly shown
--------------------------
...
[Shop Dentables](/collections "Shop Dentables")
...
margin-bottom: 125px; /\* Spacing below the heading \*/
 ...
 @media screen and (max-width: 768px) {#shopify-section-template--27795704676722\_\_7428741c-ac2a-45f5-91c5-6abe345d3f9b h2 {font-size: calc(32px / 60 \* var(--base-headings-size)); }} @media screen and (min-width: 768px) and (max-width: 1024px) {#shopify-section-template--27795704676722\_\_7428741c-ac2a-45f5-91c5-6abe345d3f9b h2 {font-size: calc(42px / 60 \* var(--base-headings-size)); }} @media screen and (min-width: 1024px) and (max-width: 1367px) {#shopify-section-template--27795704676722\_\_7428741c-ac2a-45f5-91c5-6abe345d3f9b h2 {font-size: calc(48px / 60 \* var(--base-headings-size)); }} @media screen and (min-width: 1367px) {#shopify-section-template--27795704676722\_\_7428741c-ac2a-45f5-91c5-6abe345d3f9b h2 {font-size: calc(60px / 60 \* var(--base-headings-size)); }} #shopify-section-template--27795704676722\_\_7428741c-ac2a-45f5-91c5-6abe345d3f9b h4 {font-size: calc(16px / 16 \* var(--base-body-size)); font-family: var(--font-stack-body);}

#section-template--27795704676722\_\_1704e162-b7f9-4fa5-8881-8972308f30e2 {
--main-background: #f9f8f6;
}
#section-template--27795704676722\_\_1704e162-b7f9-4fa5-8881-8972308f30e2 {
--main-text: #101010;
...
![](//www.beardbrand.com/cdn/shop/files/P1010032.jpg?v=1676500014&width=640)
...
Whether it’s [Utility Oil](/products/utility-beard-oil "Utility Beard Oil"), [Utility Balm](/products/utility-balm "Utility Balm"), or the [Utility Bar](/products/utility-bar-soap-3-pack "Utility Bar"), Beardbrand products are formulated to be incredibly versatile.
...
**UTILITY BALM CANISTERS**Once empty, the aluminum Utility Balm canister perfectly fits one Beardbrand Utility Bar, making it a natural travel case for our versatile soap pucks. We also love using the empty Utility Balm canisters around the house and in the garage to keep things like nails, screws, batteries, etc., organized.

**UTILITY BAR CANISTERS**  
...
**MUSTACHE WAX TRAYS**  
Once all the wax has been scraped out, the [Mustache Wax](/products/mustache-wax "Mustache Wax") tray can store things like aspirin and ibuprofen when traveling. This takes up significantly less space than a typical medicine bottle. And you’ll probably never look cooler popping an Advil than you will when you do it from a sleek slide-open tray.
...
margin-bottom: 125px; /\* Spacing below the heading \*/
 ...
 @media screen and (max-width: 768px) {#shopify-section-template--27795704676722\_\_1704e162-b7f9-4fa5-8881-8972308f30e2 h2 {font-size: calc(32px / 60 \* var(--base-headings-size)); }} @media screen and (min-width: 768px) and (max-width: 1024px) {#shopify-section-template--27795704676722\_\_1704e162-b7f9-4fa5-8881-8972308f30e2 h2 {font-size: calc(42px / 60 \* var(--base-headings-size)); }} @media screen and (min-width: 1024px) and (max-width: 1367px) {#shopify-section-template--27795704676722\_\_1704e162-b7f9-4fa5-8881-8972308f30e2 h2 {font-size: calc(48px / 60 \* var(--base-headings-size)); }} @media screen and (min-width: 1367px) {#shopify-section-template--27795704676722\_\_1704e162-b7f9-4fa5-8881-8972308f30e2 h2 {font-size: calc(60px / 60 \* var(--base-headings-size)); }} #shopify-section-template--27795704676722\_\_1704e162-b7f9-4fa5-8881-8972308f30e2 h4 {font-size: calc(16px / 16 \* var(--base-body-size)); font-family: var(--font-stack-body);}
...
![](https://aa.trkn.us/1/e/c.gif?cid=c013&evid=4d746137-8d1d-465b-981b-f81f6382dec0&r=1781460463743&dmn=www.beardbrand.com&pn=/pages/learn-about-us&qs=&suu=1&v1=&v2=SkE8m&v3=64X3AR0vG5jZhN3H_mqe3j8kn&v4=C7xwofhAv5eFetRb_mqe3j8kn&v5=2674)