...
var \_\_st={"a":2090478,"offset":-18000,"reqid":"eefd1f1b-b6f9-4fe7-ad2e-97cd47a6d78b-1781458079","pageurl":"www.beardbrand.com\/","u":"d477c8fc7f68","p":"home"};
...
window.ShopifyAnalytics.lib.page(null,{"pageType":"home","requestId":"eefd1f1b-b6f9-4fe7-ad2e-97cd47a6d78b-1781458079","shopifyEmitted":true});
...
/\* ===== Scoped, first-paint styles ======================================= \*/
#section-template--27795703955826\_\_text\_only\_hero\_gLPTcc{
--inline-highlight-bg: #000000;
--inline-highlight-text: #ffffff;
--inline-highlight-padding: 5px;
--type-size-min: 28px;
--type-size-vw: 4.6vw;
--type-size-max: 72px;
--type-lh: 1.4;
/\* Desktop/default inner padding for the announcement content \*/
--bb-announce-pad-x: var(--box-big-padding);
/\* Mobile inner padding override (slightly smaller) \*/
--bb-announce-pad-x-mobile: var(--box-small-padding);
}
#section-template--27795703955826\_\_text\_only\_hero\_gLPTcc .site-box { min-height: var(--box-min-height, auto); }
/\* Reduce inner padding (the “block” content padding) on mobile only \*/
#section-template--27795703955826\_\_text\_only\_hero\_gLPTcc .box\_\_announcement .site-box-content{
padding: 0 var(--bb-announce-pad-x);
}
@media screen and (max-width: 768px), screen and (max-width: 1024px) and (orientation: portrait) {
#section-template--27795703955826\_\_text\_only\_hero\_gLPTcc .box\_\_announcement .site-box-content{
padding: 0 var(--bb-announce-pad-x-mobile);
}
}
/\* Typography + ribbon defaults shared by title & RTE \*/
#section-template--27795703955826\_\_text\_only\_hero\_gLPTcc :where(.title, .rte){
font-style: italic;
font-weight: 500;
text-transform: none;
font-size: clamp(var(--type-size-min), var(--type-size-vw), var(--type-size-max));
line-height: var(--type-lh);
color: var(--inline-highlight-text);
/\* Keep words from breaking/hyphenating; wrap at spaces only \*/
overflow-wrap: normal;
word-break: keep-all;
hyphens: none;
text-wrap: balance; /\* nice multi-line balance (progressive) \*/
}
/\* Apply the ribbon to RTE inner headings & paragraphs \*/
#section-template--27795703955826\_\_text\_only\_hero\_gLPTcc .rte :is(h1,h2,h3,h4,h5,h6,p){
display: inline;
...
/\* Apply the ribbon to the heading block (matches your top example) \*/
#section-template--27795703955826\_\_text\_only\_hero\_gLPTcc .title{
display: inline;
background: var(--inline-highlight-bg);
color: var(--inline-highlight-text);
padding: var(--inline-highlight-padding);
...
#section-template--27795703955826\_\_text\_only\_hero\_gLPTcc .box--text-align-left{ text-align:left; }
#section-template--27795703955826\_\_text\_only\_hero\_gLPTcc .box--text-align-center{ text-align:center; }
/\* Links remain readable on the ribbon \*/
#section-template--27795703955826\_\_text\_only\_hero\_gLPTcc .rte a{
color: var(--inline-highlight-text);
text-decoration: underline;
}
#section-template--27795703955826\_\_text\_only\_hero\_gLPTcc .rte a:where(:hover,:focus){ text-decoration-thickness:2px; }

Beardbrand is a fragrance house disguised as a beard care company.
...
document.addEventListener('DOMContentLoaded', function() {
const kogHeading = document.getElementById('kog-heading');
let animationTriggered = false;
if ('IntersectionObserver' in window) {
const observer = new IntersectionObserver((entries) => {
if (entries[0].isIntersecting && !animationTriggered) {
kogHeading.classList.add('visible');
animationTriggered = true;
observer.disconnect();
}
}, {
// Increased root margin to trigger earlier
rootMargin: '50px 0px -50px 0px',
// Lower threshold to trigger with less visibility
threshold: 0.05
});
observer.observe(kogHeading);
} else {
function checkVisibility() {
if (animationTriggered) return;
const rect = kogHeading.getBoundingClientRect();
const windowHeight = window.innerHeight || document.documentElement.clientHeight;
// Trigger when element is closer to entering viewport
...
// Reduced backup timeout
setTimeout(() => {
if (!kogHeading.classList.contains('visible')) {
kogHeading.classList.add('visible');
}
}, 1000);
});

#shopify-section-template--27795703955826\_\_static\_pdp\_showcase\_BVdD3A .product-showcase {
--border-color: #101010;
--bg-color: #F9F8F6;
--text-color: #101010;
...
#shopify-section-template--27795703955826\_\_static\_pdp\_showcase\_BVdD3A .product-showcase\_\_grid {
display: grid;
grid-template-columns: repeat(3, 1fr);
width: 100%;
}
#shopify-section-template--27795703955826\_\_static\_pdp\_showcase\_BVdD3A .product-showcase\_\_item {
aspect-ratio: 1;
position: relative;
border-right: 1px solid var(--border-color);
border-bottom: 1px solid var(--border-color);
}
#shopify-section-template--27795703955826\_\_static\_pdp\_showcase\_BVdD3A .product-showcase\_\_item:nth-child(3n) {
border-right: none;
}
#shopify-section-template--27795703955826\_\_static\_pdp\_showcase\_BVdD3A .product-showcase\_\_item:nth-last-child(-n+3) {
border-bottom: none;
}
}
...
#shopify-section-template--27795703955826\_\_static\_pdp\_showcase\_BVdD3A .product-showcase\_\_grid::-webkit-scrollbar {
display: none;
}
#shopify-section-template--27795703955826\_\_static\_pdp\_showcase\_BVdD3A .product-showcase\_\_item {
aspect-ratio: 1;
...
#shopify-section-template--27795703955826\_\_static\_pdp\_showcase\_BVdD3A .product-showcase\_\_link {
height: 100%;
display: block;
}
#shopify-section-template--27795703955826\_\_static\_pdp\_showcase\_BVdD3A .product-showcase\_\_image {
width: 100%;
height: 100%;
display: block;
object-fit: cover;
}
#shopify-section-template--27795703955826\_\_static\_pdp\_showcase\_BVdD3A .product-showcase\_\_info {
display: none;
}
}
/\* Shared Styles \*/
...
#shopify-section-template--27795703955826\_\_static\_pdp\_showcase\_BVdD3A .product-showcase\_\_header {
display: block;
margin-bottom: 5px;
}
#shopify-section-template--27795703955826\_\_static\_pdp\_showcase\_BVdD3A .title {
display: block;
...
#shopify-section-template--27795703955826\_\_static\_pdp\_showcase\_BVdD3A .text-size--smaller {
display: block;
font-size: calc(15px / 16 \* var(--base-body-size) + 0px);
line-height: 1.2;
margin-bottom: 5px;
}
#shopify-section-template--27795703955826\_\_static\_pdp\_showcase\_BVdD3A .price {
font-family: var(--font-stack-body-bold);
font-weight: var(--font-weight-body-bold);
}
@media screen and (min-width: 768px) {
#shopify-section-template--27795703955826\_\_static\_pdp\_showcase\_BVdD3A .product-showcase\_\_link:hover .product-showcase\_\_info,
#shopify-section-template--27795703955826\_\_static\_pdp\_showcase\_BVdD3A .product-showcase\_\_link:focus-visible .product-showcase\_\_info {
opacity: 1;
}
}
...
[![A bottle of Bold Fortune Beard Oil with a pump dispenser against a grey background.](https://cdn.shopify.com/s/files/1/0209/0478/files/BOBF_travel.jpg?v=1764079446)

Beard Oil
$29-$42

Beard Oil / Hair Oil / Face Oil](/collections/beard-oil)

[![A bottle of Bold Fortune Utility Deodorant with a spray dispenser against a grey background.](https://cdn.shopify.com/s/files/1/0209/0478/files/UDBF.jpg?v=1762468027)

Utility Deodorant
$24-$27

Natural Aluminum-Free Deodorant](/collections/aluminum-free-deodorant)

[![A bottle of Bold Fortune Eau de Parfum against a grey background.](https://cdn.shopify.com/s/files/1/0209/0478/files/EDP_BF_KO.jpg?v=1764688948)

Men's Cologne
$45-$50

Alcohol-free Eau de Parfum](/collections/mens-cologne)

[![A bottle of Bold Fortune Utility Wash with a pump dispenser against a grey background.](https://cdn.shopify.com/s/files/1/0209/0478/files/uw_bf.jpg?v=1762458707)

Utility Beard Wash
$36-$39

Beard Wash / Shampoo / Body Wash](/collections/utility-beard-wash)

[![A bottle of Bold Fortune Sea Salt Spray with a sprayer dispenser against a grey background.](https://cdn.shopify.com/s/files/1/0209/0478/files/sss_bf.jpg?v=1762457593)

Sea Salt Spray
$19-$22

Hair and Beard Texturizing Spray](/collections/sea-salt-spray)

[![A bottle of Bold Fortune Utility Softener with a pump dispenser against a grey background.](https://cdn.shopify.com/s/files/1/0209/0478/files/us_bf.jpg?v=1762458707)

Utility Beard Softener
$36-$39

Beard and Hair Conditioner / Shave Lotion](/collections/utility-beard-softener)

[![A container of Bold Fortune Beard Balm against a grey background.](https://cdn.shopify.com/s/files/1/0209/0478/files/BBBF.jpg?v=1769118313)

Beard Balm
$36-$39

Beard Balm / Hair Balm / Tattoo Balm](/collections/beard-balm)

[![A round Utility Bar puck against a grey background.](https://cdn.shopify.com/s/files/1/0209/0478/files/BAR_only.jpg?v=1764021473)

Utility Bar
$42-$45

Bar Soap / Shampoo Bar / Face Wash](/collections/utility-bar-soap)

[![A container of Bold Fortune Styling Paste against a grey background.](https://cdn.shopify.com/s/files/1/0209/0478/files/sp_bf.jpg?v=1762457578)

Styling Paste
$36-$39

Medium Hold Styling Paste for Hair / Beard](/collections/styling-paste)

#section-template--27795703955826\_\_custom\_scrollable\_promo\_qYnNAB {
--main-background: #f9f8f6;
}
#section-template--27795703955826\_\_custom\_scrollable\_promo\_qYnNAB {
--main-text: ;
...
document.addEventListener('DOMContentLoaded', function () {
const section = document.querySelector('#shopify-section-template--27795703955826\_\_custom\_scrollable\_promo\_qYnNAB');
if (!section) return;
...
.marquee-template--27795703955826\_\_marquee\_banner\_Lq3JDC {
display: flex;
overflow: hidden;
height: 10vh;
user-select: none;
...
.marquee-template--27795703955826\_\_marquee\_banner\_Lq3JDC .marquee\_\_group {
flex-shrink: 0;
display: flex;
align-items: center;
justify-content: space-between;
gap: 2rem;
min-width: 100%;
animation: scroll-template--27795703955826\_\_marquee\_banner\_Lq3JDC 60s linear infinite;
}
.marquee-template--27795703955826\_\_marquee\_banner\_Lq3JDC .marquee\_\_group .marquee-text {
color: #101010;
font-family: var(--font-stack-headings);
font-weight: var(--font-weight-headings);
font-style: var(--font-style-headings);
...
.marquee-template--27795703955826\_\_marquee\_banner\_Lq3JDC .marquee\_\_group .marquee-text a {
color: inherit;
text-decoration: none;
}
.marquee-template--27795703955826\_\_marquee\_banner\_Lq3JDC .marquee\_\_group .marquee-text a:hover {
opacity: 0.8;
}
.marquee-template--27795703955826\_\_marquee\_banner\_Lq3JDC .marquee\_\_group .separator {
color: #101010;
font-family: var(--font-stack-headings);
font-weight: var(--font-weight-headings);
font-style: var(--font-style-headings);
...
/\* Scrolling animation \*/
@keyframes scroll-template--27795703955826\_\_marquee\_banner\_Lq3JDC {
from {
transform: translateX(0);
}
to {
...
.marquee-template--27795703955826\_\_marquee\_banner\_Lq3JDC:hover .marquee\_\_group {
...
#shopify-section-template--27795703955826\_\_category\_navigation\_NgDR7h .category-nav {
--border-color: #101010;
--bg-color: #F9F8F6;
--text-color: #101010;
position: relative;
...
#shopify-section-template--27795703955826\_\_category\_navigation\_NgDR7h .category-nav\_\_container {
display: flex;
width: 100%;
position: relative;
}
#shopify-section-template--27795703955826\_\_category\_navigation\_NgDR7h .category-nav\_\_item {
flex: 1;
position: relative;
border-right: 1px solid var(--border-color);
min-height: 300px;
}
#shopify-section-template--27795703955826\_\_category\_navigation\_NgDR7h .category-nav\_\_item:last-child {
border-right: none;
}
#shopify-section-template--27795703955826\_\_category\_navigation\_NgDR7h .category-nav\_\_link {
display: block;
width: 100%;
height: 100%;
position: relative;
...
#shopify-section-template--27795703955826\_\_category\_navigation\_NgDR7h .category-nav\_\_image {
width: 100%;
height: 100%;
object-fit: cover;
}
#shopify-section-template--27795703955826\_\_category\_navigation\_NgDR7h .category-nav\_\_text {
position: absolute;
bottom: 0;
left: 0;
width: 100%;
...
text-align: center;
transition: opacity 0.3s ease;
/\* Default font size for screens smaller than 768px \*/
...
#shopify-section-template--27795703955826\_\_category\_navigation\_NgDR7h .category-nav\_\_item:hover .category-nav\_\_text {
opacity: 1;
}
}
...
#shopify-section-template--27795703955826\_\_category\_navigation\_NgDR7h .category-nav\_\_container::-webkit-scrollbar {
display: none;
}
#shopify-section-template--27795703955826\_\_category\_navigation\_NgDR7h .category-nav\_\_item {
flex: 0 0 85%;
...
[![Close-up of a man with a well-groomed, thick black beard touching his chin while inspecting his facial hair. He is wearing a white robe, and the background is softly blurred.](//www.beardbrand.com/cdn/shop/files/shop_beard.jpg?v=6550664351362610278)

Shop Beard](/collections/beard)

[![A man with long, wavy, golden-brown hair and a thick, full beard gazes off to the side. He is wearing a black jacket with brass buttons against a textured beige wall.](//www.beardbrand.com/cdn/shop/files/shop_hair.jpg?v=12627632248190234470)

Shop Hair](/collections/hair)

[![A bearded man with salt-and-pepper hair and a full beard stands confidently in an outdoor urban setting. He is wearing a light blue t-shirt and has tattooed arms. A watch is visible on his wrist.](//www.beardbrand.com/cdn/shop/files/shop_body.jpg?v=18065775939642429279)

Shop Body](/collections/body)
...
[Account Login](https://account.beardbrand.com/orders?locale=en&buyer_flags=eyJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJiZWFyZGJyYW5kLm15c2hvcGlmeS5jb20iLCJmbGFncyI6W10sImV4cCI6MTc4MjA2Mjg4MCwibmJmIjoxNzgxNDU4MDgwfQ.vPg9N-lpz0M8-XU3IQbjfhNt4FRpYD_gTdxG65ROQZo&region_country=US)
...
![](https://aa.trkn.us/1/e/c.gif?cid=c013&evid=4d746137-8d1d-465b-981b-f81f6382dec0&r=1781460413736&dmn=www.beardbrand.com&pn=/&qs=&suu=1&v1=&v2=SkE8m&v3=64X3AR0vG5jZhN3H_mqe3j8kn&v4=C7xwofhAv5eFetRb_mqe3j8kn&v5=2674)!function(){var a=Math.round(Date.now()/1e3),t="https://oirt.aggle.net/image.gif?pid=A7D4T45C&puid=5a50a31b-ffe7-4bff-ba6f-17c3abbf50ae";fetch("https://alocdn.com/c/9rgi64bf/a/xtarget/p.json",{credentials:"include"}).then(function(e){return e.json()}).then(function(e){if(void 0!==e.md5\_email){var n=new Image;n.src=t+"&pih1="+e.md5\_email+"&\_="+a}})}();!function(){var lijitData={cdmn:"pxdrop.lijit.com",lm:"d",tt:"t.dhj"};!function(a){a.cls="append",a.pubid="techlist",a.puu="5a50a31b-ffe7-4bff-ba6f-17c3abbf50ae"}(lijitData);function \_pxTagInject(p,d,w,l){var o,k=[],t=p.tt.slice(-1),x={cdmn:1,lm:1,tt:1},y={cid:1,cls:1,dmn:1,pubid:1,puu:1,evid:1,aq\_m:1};p.dmn=(p.dmn||(w.top[l]===w[l]?""+w[l]:d.referrer).split("/")[2]).split(":")[0];for(o in p)(y[o]||("j"!=t||p.aq\_m)&&!x[o])&&k.push(o+"="+p[o]);var s=d.createElement("f"==t?"img":"script");s.id=s.title="lijitscrpt",s.async=s.defer=!0,s.src="//"+p.cdmn+"/1/"+p.lm+"/"+p.tt+"?"+k.join("&"),d.body.appendChild(s)}\_pxTagInject(lijitData,document,window,"location")}();![](https://i.liadm.com/s/85221?&aid=5a50a31b-ffe7-4bff-ba6f-17c3abbf50ae&ref=P965372B3&_=0.010979955590706858)