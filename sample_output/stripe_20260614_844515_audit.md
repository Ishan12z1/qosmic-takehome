# Partial Audit - Crawl Issues: https://stripe.com

Run ID: `stripe_20260614_844515`  
...
> See `artifacts/stripe_20260614_844515/summary.md` for the full machine record.
...
- 2/6 pages returned an HTTP error (4xx/5xx).
- Only 4/6 pages loaded cleanly.
...
| Critical Pages Loading | Warn | 4/6 pages loaded. 0 blocked. |
| Meta Tags & Social Previews | Pass | Title, meta description, and OG tags present on all 4 crawled pages. |
| Structured Data | Warn | No JSON-LD detected across 4 crawled pages. |
| Favicon | Pass | Favicon link tag found. |
| Mobile-Friendly | Pass | Viewport meta present and no horizontal overflow at 375px. |
| Page Speed Mobile | Pass | Navigation timing (single run, not Lighthouse): load 1981ms, DCL 982ms at 375px viewport. |
| Page Speed Desktop | Pass | Navigation timing (single run, not Lighthouse): load 1873ms, DCL 931ms. |
| Broken Links | Pass | No broken links in 15 sampled links. |
| Image Optimization | Warn | 41/137 images missing alt text (29%) across 4 crawled pages. Byte-level audit not run. |
...
Evidence: `artifacts/stripe_20260614_844515/summary.md`, `artifacts/stripe_20260614_844515/discovered_links.json`
